...
#########################################################################
    ...
    def UplodeSounds(self):
        ...
        print(sound_file_names)
        index = 0
        for sound_name in sound_file_names:
            self.sound_name_list.append(sound_name)
            relative_path = f"./{sound_name}"
            print(relative_path)


            self.full_path.append(relative_path)
...
##############################################################
    def MuteSound(self, index):
        ...
        if is_muted:
            ...
            self.channel_list[index].unpause()
            print(self.channel_list[index])
        else:
            if self.is_loop == False:
                ...
                #chanel.pause()
                # self.channel_list[index].stop()
                self.channel_list[index].pause()
                #chanel.pause()
                print(self.channel_list[index])
